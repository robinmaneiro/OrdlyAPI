package com.robinmaneiro.ordly.api.guest.service
...
import com.robinmaneiro.ordly.api.database.repository.GuestSessionRepository
import com.robinmaneiro.ordly.api.database.repository.RefreshGuestSessionRepository
...
class GuestService(
    ...
    fun createGuestSession(): TokenPair {
        ...
        bagService.createBag(bagId, "Guest")
